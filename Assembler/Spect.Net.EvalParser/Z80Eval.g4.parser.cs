...
{
    public partial class Z80EvalParser
    {
        /// <summary>
        /// Syntax errors caught during the parsing phase
        /// </summary>
        public List<Z80EvalParserErrorInfo> SyntaxErrors { get; } = new List<Z80EvalParserErrorInfo>();

        /// <summary>Resets the parser's state</summary>
        public override void Reset()
        {
            base.Reset();
            RemoveErrorListeners();
            AddErrorListener(new Z80TestErrorListener(this));
        }

        private class Z80TestErrorListener : IAntlrErrorListener<IToken>
        {
            /// <summary>
            /// The parser that utilizes this error listener
            /// </summary>
            private Z80EvalParser Parser { get; }

            /// <summary>Initializes a new instance of the <see cref="T:System.Object" /> class.</summary>
            public Z80TestErrorListener(Z80EvalParser parser)
            {
                Parser = parser;
            }
